#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Mon 16 Dec 00:06:33 GMT 2024      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 1 --mpi=pmix_v4 --mem-per-cpu=61440 nice -n 10 /mnt/users/dperkovic/quantum_hall_dmrg/tenpy/NEW_COMMITS/multilayer_vacuum.py 129 50 []
  echo ---------------                                           
