...
class QH_system():
    ...
    def patch_WFs(self):
        ...
        if z<0.01:
            with open('/mnt/users/dperkovic/quantum_hall_dmrg/tenpy/NEW_COMMITS/Pf_Apf_truncated_charges_success='+str(self.sides_added)+'.txt','a') as f:
...
if __name__ == "__main__":
    ...
    params = {}
    params['verbose'] = 1
    params['sys length'] = 150+12*4+16+16
    params['half']=half
