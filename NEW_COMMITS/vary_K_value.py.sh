#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Mon 23 Dec 01:22:00 GMT 2024      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 1 --mpi=pmix_v4 --mem-per-cpu=20480 nice -n 10 /mnt/users/dperkovic/quantum_hall_dmrg/tenpy/NEW_COMMITS/vary_K_value.py a b []
  echo ---------------                                           
