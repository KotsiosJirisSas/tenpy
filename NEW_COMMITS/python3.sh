#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Wed  6 Nov 13:49:00 GMT 2024      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 1 --mpi=pmix_v4 --mem-per-cpu=20480 nice -n 10 /usr/bin/python3 /mnt/users/dperkovic/quantum_hall_dmrg/tenpy/NEW_COMMITS/nu_1_3_edge.py
  echo ---------------                                           
